    ...
    <>
      <div className="flex flex-col md:flex-row gap-5">
        ...
        <div className="md:w-64 md:h-screen py-5 bg-blue-200 shadow-lg">
          <div className="ps-4">
            <h1 className=" font-nunito text-4xl font-bold text-[#001735] uppercase">
              Cox Crab
            </h1>
            <h2 className="font-heebo text-xl font-semibold text-[rgba(0,23,53,0.8)]">
              Restaurant
            </h2>
          </div>
            ...
            {isAdmin ? (
              ...
              <>
                ...
                <li>
                  ...
                  >
                    <TiThMenu></TiThMenu> Payment History
                  </NavLink>
                </li>
                <li>
                  <NavLink
